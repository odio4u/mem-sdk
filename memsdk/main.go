...
func main() {
	...
	gateways, err := client.Addgateway(ctx, region, "127.0.0.1", 8082, "cnkdllsckmlmemfme", 4000)
	if err != nil {
		panic(err)
	}
	println("Added Gateway:", gateways.ID, gateways.GatewayPort, gateways.WssPort, gateways.IP)
}
